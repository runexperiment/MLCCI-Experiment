fuzzyCal MATLAB Python Package
...
2. Installing the fuzzyCal Package

A. Change to the directory that contains the file setup.py and the subdirectory fuzzyCal. 
...
3. Using the fuzzyCal Package

The fuzzyCal package is on your Python path. To import it into a Python script or 
session, execute:
