...
import FaultMe
import Tool_io
from MyTest2 import deal_program
...
def cal_metrics(root, data, error_pro_ver, res_path):
    ...
    pros_op = {}
    pros_op2 = {}
    pros_all = ['/home/tianshuaihua/base_dataset/Chart','/home/tianshuaihua/base_dataset/Time','/home/tianshuaihua/base_dataset/Mockito', '/home/tianshuaihua/base_dataset/Lang','/home/tianshuaihua/base_dataset/Math','/home/tianshuaihua/base_dataset/Closure']
    for pros in all:
        if pros not in pros_all:
            continue
        vers_op = {}
        vers_op2 = {}
        for ver in all[pros]:
            if os.path.exists(os.path.join(ver[1],'sus_value')):
                ...
                for sv in sus_value:
                    try:
                        top_res = getTop(sus_value[sv],fault_index,[1,2,3,5,10])
...
def cal_end(all_pro,res_path,model_path,data_path,ver_data):
    top_all = all_pro[0]
...
def deal_csv(p,wasted,res_path):
    ...
    for pro in wasted:
        ...
        rows.append(row)
    creat_res_file(rows,res_path,'wasted_agv')
    print("s")
...
def creat_res_file_top(rows,res_path,csv_name):
    ...
    header = ['', 'sus_formula', 'top-10','top-5','top-3','top-2','top-1']
...
if __name__ =="__main__":
    ...
    cal_end(all_pro,res_path,model_path,data,ver_data)
